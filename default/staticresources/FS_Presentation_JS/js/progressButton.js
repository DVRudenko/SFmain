...
;( function( window ) {
    ...
    ProgressButton.prototype._create = function() {
        this.onLoadText = this.button.getAttribute( 'data-text' );
        this.currentText = this.button.innerHTML;
    ...
    ProgressButton.prototype._initEvents = function() {
        ...
        this.button.addEventListener( 'click', function() {
            ...
            self.button.getElementsByClassName('content')[0].innerHTML = self.onLoadText;
    ...
    ProgressButton.prototype._stop = function( status ) {
        ...
        setTimeout( function() {
            ...
            self.button.getElementsByClassName('content')[0].innerHTML = self.currentText;
        }, 100 );
    };
